...
export default function LeftBar() {
  ...
  return (
    <div className="border 1 border-black-500  pt-10 max-w-70 font-sans font-medium text-base">
      <div className="ml-3">
      ...
      <div className="border-1 border-gray-200 w-[95%] flex justify-self-center"></div>
      <div className="ml-3 flex flex-col">
        ...
        >
          <div className="bg-linear-to-t from-cyan-500 to-green-500 h-8 w-8 rounded border-1 border-blue-500">
